            ...
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        ...
                        <input wire:model.defer="name" type="text" class="form-control" name="name" id="name" placeholder="Nome da Extensão">
                        @error('name') <span class="text-danger error">{{ $message }}</span>@enderror
                    </div>
                    <div class="form-group">
                        <label for="price">Preço:</label>
                        <input wire:model.defer="price" type="number" name="price" min="0" value="0" step=".01" class="form-control" id="price" placeholder="Preço">
